...
<html>
	<head>
        ...
        <!--
            SweetAlert Import (Alery Design)
        -->
            ...
            <div class="textbox" style="margin : 0 auto;">
                ...
                <div class="container-fluid">
                    <div class="row">
						...
						%>
                        <div class="col-4 user">
                            <form action="<%=request.getContextPath() %>/user/2" method="post" name="createuser">
                                <div class="textbox">
                                    <a onclick="winOpen()"><input type="text" name="id"></a>
                                </div>
                                ...
                                <div class="textbox">
                                    <a onclick="daumPostCode()"><input id="addr" type="text" name="addr" value=""></a>
                                </div>
                                ...
                                <div class="container-fluid" style="margin-top:10px;">
                                    <div class="row" style=" margin: 0 auto;">
                                        <div class="col-6">
                                            <div id="mypage">
                                            <button type="button" onclick="userCreateConfirm()" class="btn">회원가입</button>
                                            </div>
                                        </div>
                    
                                        <div class="col-6">
                                            <div id="mypage">
                                            <button type="button" onclick="javascript:window.location='<%=request.getContextPath() %>/main'" class="btn">취소</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-4 user">
                            <div style="float:left;">
                            	<div id="mypage" style="margin-top:15px;">
	                            	<button type="button" onclick="winOpen()" class="btn">ID 중복체크</button>
	                            </div>
	                            
	                            <div id="mypage" style="margin-top:205px;">
